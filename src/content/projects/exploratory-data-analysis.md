...
technologies:
  ...
  - name: "Matplotlib"
    route: "/svg/matplotlib.svg"
  - name: "Seaborn"
    route: "/svg/seaborn.svg"
---

An in-depth Exploratory Data Analysis (EDA) project designed to uncover patterns and relationships between students daily habits and their academic performance.
The dataset, sourced from Kaggle, includes information on study hours, sleep patterns, diet quality, social media use, and exam results.
